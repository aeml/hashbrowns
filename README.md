...
- `--baseline-report-json FILE` writes a machine-readable JSON summary of metadata compatibility, per-structure deltas, comparison decision basis, threshold/noise settings, strictness mode, and final exit classification.
